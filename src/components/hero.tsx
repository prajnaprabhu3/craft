...
const Hero = () => {
  return (
    <div className="flex flex-col items-center gap-y-4 my-20 ">
      <Badge />
      <div className="flex flex-col items-center text-2xl md:text-4xl gap-y-3 font-bold">
        ...
        <h2 className="text-transparent text-3xl md:text-5xl bg-clip-text bg-gradient-to-r to-purple-300 from-[#e8778c]">
          Interface
        </h2>
      </div>
